...
class YaScooterOrderPageData:
    data_sets = {
        'data_set1': {
            'first_name': 'Стас',
            'last_name': 'Пузачев',
            'address': 'Ново-вокзальная 20',
            'subway_name': 'Маяковского',
            'telepthone_number': '+123456789',
            'date': '17.07.2025',
            'rental_period': 0,
            'color': [0],
            'comment_for_courier': 'Позвонить за 15 минут',
            'description': 'Корректные данные'
        },
        'data_set2':
            {'first_name': 'Иван',
             'last_name': 'Ивонов',
             'address': 'Ново Садовая',
             'subway_name': 'Лубянка',
             'telepthone_number': '+3424146789',
             'date': '20.07.2025',
             'rental_period': 1,
             'color': [0, 1],
